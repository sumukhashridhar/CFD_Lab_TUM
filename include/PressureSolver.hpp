...
class PressureSolver {
  public:
     ...
     */
    virtual dtype solve(Fields &field, Grid &grid, const std::vector<std::unique_ptr<Boundary>> &boundaries) = 0;
};
...
class SOR : public PressureSolver {
  public:
     ...
     * @param[in] boundary to be used
     */
    virtual dtype solve(Fields &field, Grid &grid, const std::vector<std::unique_ptr<Boundary>> &boundaries);
